...
>
  <div className="flex flex-col md:flex-row gap-8 md:gap-12 justify-center items-center px-4 sm:px-6 md:px-10 lg:px-12 py-10">
    ...
    <div className="column2 text-white w-full md:w-auto relative">
      ...
      <p className="font-normal text-[#999999] text-sm sm:text-base leading-7 sm:leading-8">
        Our catering service provides an exceptional culinary experience for your{" "}
        <br className="hidden md:block" />
        next event. Whether you are hosting a corporate gathering, a wedding, or a{" "}
        <br className="hidden md:block" />
        private party, we offer a wide range of menu options to suit your taste and{" "}
        <br className="hidden md:block" />
        dietary preferences.
        <br className="hidden md:block" />
        Our team of professional chefs and staff take pride in using only the{" "}
        <br className="hidden md:block" />
        freshest ingredients and preparing everything from scratch to ensure{" "}
        <br className="hidden md:block" />
        quality and taste. We can create customized menus that suit your event{" "}
        <br className="hidden md:block" />
        theme, or you can choose from our pre-designed menu options that cater{" "}
        <br className="hidden md:block" />
        to a variety of tastes. We take pride in making every event memorable,
        <br className="hidden md:block" />
        ...
        expectations
        <br className="hidden md:block" />
        and provide a dining experience that you and your guests will remember{" "}
        <br className="hidden md:block" />
      ...
      <div>
        <Image
          width={250}
          height={200}
          className="absolute right-2 sm:right-4 md:right-6 top-2 sm:top-3 md:top-4 w-[150px] sm:w-[200px] md:w-[250px] h-auto"
          src={Img1}
          alt="absolute"
        ...
        <Image
          width={250}
          height={200}
          className="absolute right-2 sm:right-4 md:right-6 top-[10%] sm:top-[8%] md:top-[7%] w-[150px] sm:w-[200px] md:w-[250px] h-auto"
          src={Img2}
          alt="absolute"
          sizes="(max-width: 640px) 150px, (max-width: 1024px) 200px, 250px"
        />
